#ifndef SL_EMLIB_GPIO_INIT_ALARM_TEMP_CONFIG_H
#define SL_EMLIB_GPIO_INIT_ALARM_TEMP_CONFIG_H

// <<< Use Configuration Wizard in Context Menu >>>

// <h>Pin settings

// <o SL_EMLIB_GPIO_INIT_ALARM_TEMP_MODE> Pin mode
...
#define SL_EMLIB_GPIO_INIT_ALARM_TEMP_MODE        gpioModeInput

// <o SL_EMLIB_GPIO_INIT_ALARM_TEMP_DOUT> DOUT <0-1>
...
// <i> Default: 0
#define SL_EMLIB_GPIO_INIT_ALARM_TEMP_DOUT        0
...
// <gpio> SL_EMLIB_GPIO_INIT_ALARM_TEMP
// $[GPIO_SL_EMLIB_GPIO_INIT_ALARM_TEMP]
#define SL_EMLIB_GPIO_INIT_ALARM_TEMP_PORT       gpioPortA
#define SL_EMLIB_GPIO_INIT_ALARM_TEMP_PIN        4
// [GPIO_SL_EMLIB_GPIO_INIT_ALARM_TEMP]$

// <<< sl:end pin_tool >>>

#endif // SL_EMLIB_GPIO_INIT_ALARM_TEMP_CONFIG_H
